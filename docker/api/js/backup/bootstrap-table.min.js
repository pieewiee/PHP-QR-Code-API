(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      (global.BootstrapTable = factory(global.jQuery)));
})(this, function ($) {
  "use strict";
  ...
  // Nashorn ~ JDK8 bug
  var NASHORN_BUG =
    getOwnPropertyDescriptor$4 && !nativePropertyIsEnumerable.call({ 1: 2 }, 1);
  ...
  */
  ...
  _export(
    { target: "Array", proto: true, forced: FORCED$4 },
    {
  ...
  // https://tc39.es/ecma262/#sec-array.prototype.foreach
  var arrayForEach = !STRICT_METHOD$2
  ...
  _export(
    { target: "Array", proto: true, forced: FORCED$2 },
    {
  ...
  if (FORCED) {
    var RegExpWrapper = function RegExp(pattern, flags) {
      ...
      if (UNSUPPORTED_Y && sticky)
        setInternalState$1(result, { sticky: sticky });

      return result;
    };
    var proxy = function (key) {
      key in RegExpWrapper ||
        defineProperty$2(RegExpWrapper, key, {
          configurable: true,
          get: function () {
    ...
    formatShowingRows: function formatShowingRows(
      ...
      if (
        ...
        return "Showing "
          .concat(pageFrom, " to ")
          .concat(pageTo, " of ")
          .concat(totalRows, " rows (filtered from ")
          .concat(totalNotFiltered, " total rows)");
      }

      return "Showing "
        .concat(pageFrom, " to ")
        .concat(pageTo, " of ")
        .concat(totalRows, " rows");
    },
  ...
  var MDN_POLYFILL_BUG$1 =
    ...
    !!(function () {
      var descriptor = getOwnPropertyDescriptor$1(
        String.prototype,
        "startsWith"
      );
  ...
  _export(
    ...
    },
    {
      startsWith: function startsWith(searchString /* , position = 0 */) {
        ...
        notARegexp(searchString);
        var index = toLength(
          min$1(arguments.length > 1 ? arguments[1] : undefined, that.length)
        );
  ...
  _export(
    ...
    },
    {
      endsWith: function endsWith(searchString /* , endPosition = @length */) {
        ...
        var end =
          endPosition === undefined ? len : min(toLength(endPosition), len);
        var search = String(searchString);
  ...
  var Utils = {
    ...
    updateFieldGroup: function updateFieldGroup(columns) {
      ...
      var allColumns = (_ref = []).concat.apply(
        _ref,
          ...
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
              ...
              if (r.colspanGroup > 1) {
                ...
                for (
                  var i = r.colspanIndex;
                  i < r.colspanIndex + r.colspanGroup;
                  i++
                ) {
                  _loop(i);
                }
    ...
    getScrollBarWidth: function getScrollBarWidth() {
      if (this.cachedWidth === undefined) {
        var $inner = $__default["default"]("<div/>").addClass(
          "fixed-table-scroll-inner"
        );
        var $outer = $__default["default"]("<div/>").addClass(
    ...
    calculateObjectValue: function calculateObjectValue(
      self,
      name,
      args,
      defaultValue
      ...
      if (
        !func &&
        typeof name === "string" &&
        this.sprintf.apply(this, [name].concat(_toConsumableArray(args)))
      ) {
        return this.sprintf.apply(
          this,
    ...
    getRealDataAttr: function getRealDataAttr(dataAttr) {
      for (
        var _i3 = 0, _Object$entries = Object.entries(dataAttr);
    ...
    getDetailViewIndexOffset: function getDetailViewIndexOffset(options) {
      return this.hasDetailViewIcon(options) &&
    ...
    checkAutoMergeCells: function checkAutoMergeCells(data) {
      ...
      try {
        for (_iterator9.s(); !(_step9 = _iterator9.n()).done; ) {
          ...
          for (
            var _i4 = 0, _Object$keys = Object.keys(row);
            ...
            if (
              key.startsWith("_") &&
              (key.endsWith("_rowspan") || key.endsWith("_colspan"))
            ) {
              return true;
            }
          }
    ...
    deepCopy: function deepCopy(arg) {
      ...
      return $__default["default"].extend(
        true,
        Array.isArray(arg) ? [] : {},
        arg
      );
    ...
    _createClass(VirtualScroll, [
      {
        ...
        value: function initDOM(rows, fixedScroll) {
          ...
          var bottomOffsetChanged = this.checkChanges(
            "bottom",
            data.bottomOffset
          );
          var html = [];
    ...
    _createClass(BootstrapTable, [
      ...
      },
      {
        ...
        value: function initConstants() {
          ...
          var buttonsPrefix = opts.buttonsPrefix
            ? "".concat(opts.buttonsPrefix, "-")
            : "";
          this.constants.buttonsClass = [
            opts.buttonsPrefix,
            buttonsPrefix + opts.buttonsClass,
            Utils.sprintf("".concat(buttonsPrefix, "%s"), opts.iconSize),
          ]
            .join(" ")
            .trim();
      ...
      },
      {
        ...
        value: function initContainer() {
          var topPagination = ["top", "both"].includes(
            this.options.paginationVAlign
          )
            ? '<div class="fixed-table-pagination clearfix"></div>'
            : "";
          var bottomPagination = ["bottom", "both"].includes(
            this.options.paginationVAlign
          )
            ? '<div class="fixed-table-pagination"></div>'
            : "";
          var loadingTemplate = Utils.calculateObjectValue(
            this.options,
          ...
          if (this.options.buttonsToolbar) {
            this.$toolbar = $__default["default"]("body").find(
      ...
      },
      {
        ...
        value: function initTable() {
          ...
          if (!this.$header.length) {
            this.$header = $__default["default"](
              '<thead class="'.concat(this.options.theadClasses, '"></thead>')
            ).appendTo(this.$el);
          ...
          this.options.columns = $__default["default"].extend(
            true,
            [],
            columns,
          ...
          if (
            ...
            this.footerData = Utils.trToData(
              this.columns,
        ...
        value: function initHeader() {
          ...
          this.options.columns.forEach(function (columns, i) {
            ...
            html.push(
              "<tr"
                .concat(
                  Utils.sprintf(' class="%s"', _this2._headerTrClasses[i]),
                  " "
                )
                .concat(
                  Utils.sprintf(' style="%s"', _this2._headerTrStyles[i]),
                  ">"
                )
            );
            ...
            if (i === 0 && Utils.hasDetailViewIcon(_this2.options)) {
              var rowspan =
                _this2.options.columns.length > 1
                  ? ' rowspan="'.concat(_this2.options.columns.length, '"')
                  : "";
              detailViewTemplate = '<th class="detail"'.concat(
                rowspan,
            ...
            if (
              detailViewTemplate &&
              _this2.options.detailViewAlign !== "right"
            ) {
            ...
            columns.forEach(function (column, j) {
              ...
              var headerStyle = Utils.calculateObjectValue(
                null,
                _this2.options.headerStyle,
                [column]
              );
              var csses = [];
              var classes = "";
              ...
              if (headerStyle && headerStyle.css) {
                for (
                  var _i = 0, _Object$entries = Object.entries(headerStyle.css);
              ...
              if (headerStyle && headerStyle.classes) {
                classes = Utils.sprintf(
                  ' class="%s"',
                  column["class"]
                    ? [column["class"], headerStyle.classes].join(" ")
                    : headerStyle.classes
                );
              }
              ...
              if (typeof column.fieldIndex !== "undefined") {
                ...
                _this2.header.detailFormatters[column.fieldIndex] =
                  column.detailFormatter;
              ...
              html.push(
                "<th".concat(Utils.sprintf(' title="%s"', column.titleTooltip)),
                ...
                Utils.sprintf(' data-field="%s"', column.field), // If `column` is not the first element of `this.options.columns[0]`, then className 'data-not-first-th' should be added.
              ...
              html.push(
                Utils.sprintf(
                  ...
                  _this2.options.sortable && column.sortable
                    ? "sortable both"
                    : ""
                )
              );
              var text = _this2.options.escape
                ? Utils.escapeHTML(column.title)
                : column.title;
              var title = text;
              ...
              if (column.checkbox) {
                ...
                if (
                  !_this2.options.singleSelect &&
                  _this2.options.checkboxHeader
                ) {
                  text =
          ...
          this.$header.find("th[data-field]").each(function (i, el) {
            $__default["default"](el).data(
              visibleColumns[$__default["default"](el).data("field")]
            );
          });
          this.$container
            .off("click", ".th-inner")
            .on("click", ".th-inner", function (e) {
              ...
              if (
                _this2.options.detailView &&
                !$this.parent().hasClass("bs-checkbox")
              ) {
                if (
                  $this.closest(".bootstrap-table")[0] !== _this2.$container[0]
                ) {
                  return false;
                }
              }
          ...
          this.$header
            ...
            .on("keypress", function (e) {
              if (
                _this2.options.sortable &&
                $__default["default"](e.currentTarget).data().sortable
              ) {
          ...
          var resizeEvent = Utils.getEventName(
      ...
      },
      {
        ...
        value: function initData(data, type) {
          if (type === "append") {
            ...
            this.options.data = Array.isArray(data)
              ? data
          ...
          if (index !== -1) {
            ...
            if (this.options.customSort) {
              ...
              this.data.sort(function (a, b) {
                ...
                var value = Utils.calculateObjectValue(
                  _this3.header,
                  _this3.header.sorters[index],
                  [aa, bb, a, b]
                );
            ...
            if (this.options.sortClass !== undefined) {
              ...
              timeoutId = setTimeout(function () {
                ...
                var index = _this3.$header
                  .find('[data-field="'.concat(_this3.options.sortName, '"]'))
                  .index();

                _this3.$el
                  .find("tr td:nth-child(".concat(index + 1, ")"))
        ...
        value: function onSort(_ref) {
          ...
          if (this.options.sortName === $this.data("field")) {
            ...
            if (this.options.rememberOrder) {
              ...
              this.options.sortOrder =
                this.columns[this.fieldsColumnsIndex[$this.data("field")]]
                  .sortOrder ||
                this.columns[this.fieldsColumnsIndex[$this.data("field")]]
                  .order;
            }
      ...
      },
      {
        ...
        value: function initToolbar() {
          ...
          if (this.$toolbar.find(".bs-bars").children().length) {
            $__default["default"]("body").append(
              $__default["default"](opts.toolbar)
            );
          }
          ...
          if (
            typeof opts.toolbar === "string" ||
            _typeof(opts.toolbar) === "object"
          ) {
            $__default["default"](
              Utils.sprintf(
              ...
              .append($__default["default"](opts.toolbar));
          ...
          if (typeof opts.buttonsOrder === "string") {
            opts.buttonsOrder = opts.buttonsOrder
              .replace(/\[|\]| |'/g, "")
              .split(",");
          }
          ...
          this.buttons = Object.assign(this.buttons, {
            paginationSwitch: {
              text: opts.pagination
                ? opts.formatPaginationSwitchUp()
                : opts.formatPaginationSwitchDown(),
              icon: opts.pagination
                ? opts.icons.paginationSwitchDown
            ...
            columns: {
              ...
              html: function html() {
                ...
                html.push(
                  '<div class="keep-open '
                    .concat(
                      _this4.constants.classes.buttonsDropdown,
                      '" title="'
                    )
                    .concat(
                      opts.formatColumns(),
                    ...
                    .concat(
                      _this4.constants.buttonsClass,
                      ' dropdown-toggle" type="button" '
                    )
                    .concat(
                      _this4.constants.dataToggle,
                      '="dropdown"\n            aria-label="Columns" title="'
                    )
                    .concat(opts.formatColumns(), '">\n            ')
                    .concat(
                      opts.showButtonIcons
                        ? Utils.sprintf(
                            _this4.constants.html.icon,
                            opts.iconsPrefix,
                            opts.icons.columns
                          )
                        : "",
                    ...
                    .concat(
                      _this4.constants.html.dropdownCaret,
                      "\n            </button>\n            "
                    )
                ...
                if (opts.showColumnsSearch) {
                  html.push(
                    Utils.sprintf(
                      _this4.constants.html.toolbarDropdownItem,
                      Utils.sprintf(
                ...
                if (opts.showColumnsToggleAll) {
                  var allFieldsVisible =
                    _this4.getVisibleColumns().length ===
                    _this4.columns.filter(function (column) {
                ...
                _this4.columns.forEach(function (column, i) {
                  ...
                  var disabled =
                    visibleColumns <= opts.minimumCountColumns && checked
                      ? ' disabled="disabled"'
                      : "";
          ...
          for (
            var _i2 = 0, _Object$entries2 = Object.entries(this.buttons);
            ...
            if (buttonConfig.hasOwnProperty("html")) {
              ...
              buttonHtml = '<button class="'
                .concat(this.constants.buttonsClass, '" type="button" name="')
                .concat(buttonName, '"');

              if (buttonConfig.hasOwnProperty("attributes")) {
                for (
                  var _i3 = 0,
                    _Object$entries3 = Object.entries(buttonConfig.attributes);
            ...
            var optionName = "show"
              .concat(buttonName.charAt(0).toUpperCase())
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              var _showOption =
                opts[
                  "show"
                    .concat(button.charAt(0).toUpperCase())
          ...
          for (
            var _i4 = 0, _Object$entries4 = Object.entries(this.buttons);
            ...
            if (_buttonConfig.hasOwnProperty("event")) {
              if (
                typeof _buttonConfig.event === "function" ||
                typeof _buttonConfig.event === "string"
              ) {
                var _ret = (function () {
                  var event =
                    typeof _buttonConfig.event === "string"
                      ? window[_buttonConfig.event]
                      : _buttonConfig.event;

                  _this4.$toolbar
                    .find('button[name="'.concat(_buttonName, '"]'))
                    .off("click")
                    .on("click", function () {
              ...
              for (
                var _i5 = 0,
                  _Object$entries5 = Object.entries(_buttonConfig.event);
          ...
          if (opts.showColumns) {
            ...
            $toggleAll.off("click").on("click", function (_ref3) {
              ...
              _this4._toggleAllColumns(
                $__default["default"](currentTarget).prop("checked")
              );
            });
          ...
          if (
            ...
            html = [];
            var showSearchButton = Utils.sprintf(
            ...
            var showSearchClearButton = Utils.sprintf(
              ...
              opts.showButtonIcons
                ? Utils.sprintf(
                    this.constants.html.icon,
                    opts.iconsPrefix,
                    opts.icons.clearSearch
                  )
                : "",
              opts.showButtonText ? opts.formatClearSearch() : ""
            );
            var searchInputHtml = '<input class="'
            ...
            if (opts.showSearchButton || opts.showSearchClearButton) {
              var _buttonsHtml =
                (opts.showSearchButton ? showSearchButton : "") +
                (opts.showSearchClearButton ? showSearchClearButton : "");

              searchInputFinalHtml = opts.search
                ? Utils.sprintf(
            ...
            html.push(
              Utils.sprintf(
                '\n        <div class="'
                  .concat(this.constants.classes.pull, "-")
                  .concat(opts.searchAlign, " search ")
                  .concat(
      ...
      },
      {
        ...
        value: function onSearch() {
          ...
          if (
            ...
            $__default["default"](currentTarget).length &&
            overwriteSearchText
          ) {
            ...
            if (
              currentTarget === Utils.getSearchInput(this)[0] ||
              $__default["default"](currentTarget).hasClass("search-input")
            ) {
        ...
        value: function initSearch() {
          ...
          if (this.options.sidePagination !== "server") {
            if (this.options.customSearch) {
              this.data = Utils.calculateObjectValue(
                this.options,
            ...
            var s =
              this.searchText &&
              (this.fromHtml
                ? Utils.escapeHTML(this.searchText)
                : this.searchText
              ).toLowerCase();
            var f = Utils.isEmptyObject(this.filterColumns)
              ? null
              : this.filterColumns;
                    ...
                    if (filterAlgorithm === "and") {
                      for (var key in f) {
                        if (
                          ...
                          (!Array.isArray(f[key]) && item[key] !== f[key])
                        ) {
                          return false;
                        }
                      }
                      ...
                      for (var _key in f) {
                        if (
                          (Array.isArray(f[_key]) &&
                            f[_key].includes(item[_key])) ||
                          (!Array.isArray(f[_key]) && item[_key] === f[_key])
                        ) {
                          match = true;
                        }
                      }
            ...
            this.data = s
              ? this.data.filter(function (item, i) {
                  for (var j = 0; j < _this5.header.fields.length; j++) {
                    if (
                      !_this5.header.searchables[j] ||
                      (_this5.options.visibleSearch &&
                        visibleFields.indexOf(_this5.header.fields[j]) === -1)
                    ) {
                      continue;
                    }

                    var key = Utils.isNumeric(_this5.header.fields[j])
                      ? parseInt(_this5.header.fields[j], 10)
                      : _this5.header.fields[j];
                    ...
                    if (
                      ...
                      if (_this5.options.strictSearch) {
                        ...
                        var largerSmallerEqualsRegex =
                          /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(-?\d+)?|(-?\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm;
                        var matches = largerSmallerEqualsRegex.exec(
                          _this5.searchText
                        );
                        ...
                        if (
                          comparisonCheck ||
                          "".concat(value).toLowerCase().includes(s)
                        ) {
                          return true;
                        }
                      }
        ...
        value: function initPagination() {
          ...
          pageList = pageList.map(function (value) {
            if (typeof value === "string") {
              return value.toLowerCase() ===
                opts.formatAllRows().toLowerCase() ||
          ...
          if (
            ...
            var paginationInfo = this.paginationParts.includes("pageInfoShort")
              ...
              : opts.formatShowingRows(
                  this.pageFrom,
                  this.pageTo,
                  opts.totalRows,
                  opts.totalNotFiltered
                );
            html.push(
          ...
          if (this.paginationParts.includes("pageSize")) {
            ...
            pageList.forEach(function (page, i) {
              if (
                !opts.smartDisplay ||
                i === 0 ||
                pageList[i - 1] < opts.totalRows ||
                page === opts.formatAllRows()
              ) {
                var active;
                ...
                if (allSelected) {
                  active =
                    page === opts.formatAllRows()
                      ? _this6.constants.classes.dropdownActive
                      : "";
                } else {
                  active =
                    page === opts.pageSize
                ...
                pageNumber.push(
                  Utils.sprintf(
                    _this6.constants.html.pageDropdownItem,
                    active,
                    page
                  )
                );
          ...
          if (this.paginationParts.includes("pageList")) {
            html.push(
              '<div class="'
                .concat(this.constants.classes.pull, "-")
                .concat(opts.paginationHAlign, ' pagination">'),
              Utils.sprintf(
                this.constants.html.pagination[0],
                Utils.sprintf(" pagination-%s", opts.iconSize)
              ),
              Utils.sprintf(
                this.constants.html.paginationItem,
                " page-pre",
                opts.formatSRPaginationPreText(),
                opts.paginationPreText
              )
            );
            ...
            if (opts.paginationSuccessivelySize > this.totalPages - from) {
              from =
                from -
                (opts.paginationSuccessivelySize - (this.totalPages - from)) +
                1;
            }
            ...
            var pageItem = function pageItem(i) {
              ...
              return Utils.sprintf(
                _this6.constants.html.paginationItem,
                classes +
                  (i === opts.pageNumber
                    ? " ".concat(_this6.constants.classes.paginationActive)
                    : ""),
                opts.formatSRPaginationPageText(i),
                i
              );
            };
            ...
            if (from > 1) {
              ...
              if (from - 1 === max + 1) {
                ...
                if (
                  from - opts.paginationPagesBySide * 2 >
                    opts.paginationPagesBySide &&
            ...
            html.push(
              Utils.sprintf(
                this.constants.html.paginationItem,
                " page-next",
                opts.formatSRPaginationNextText(),
                opts.paginationNextText
              )
            );
      ...
      },
      {
        ...
        value: function updatePagination(event) {
          ...
          if (
            event &&
            $__default["default"](event.currentTarget).hasClass("disabled")
          ) {
            return;
          }
      ...
      },
      {
        ...
        value: function onPageNumber(event) {
          ...
          if (
            this.options.pageNumber ===
            +$__default["default"](event.currentTarget).text()
          ) {
            return;
          }

          this.options.pageNumber = +$__default["default"](
            event.currentTarget
          ).text();
          this.updatePagination(event);
          return false;
      ...
      },
      {
        ...
        value: function initRow(item, i, data, trFragments) {
          ...
          style = Utils.calculateObjectValue(
            this.options,
          ...
          if (style && style.css) {
            for (
              var _i7 = 0, _Object$entries6 = Object.entries(style.css);
              _i7 < _Object$entries6.length;
              _i7++
            ) {
              var _Object$entries6$_i = _slicedToArray(
                  _Object$entries6[_i7],
                  2
                ),
          ...
          attributes = Utils.calculateObjectValue(
            this.options,
          ...
          if (attributes) {
            for (
              var _i8 = 0, _Object$entries7 = Object.entries(attributes);
              _i8 < _Object$entries7.length;
              _i8++
            ) {
              var _Object$entries7$_i = _slicedToArray(
                  _Object$entries7[_i8],
                  2
                ),
              ...
              htmlAttributes.push(
                "".concat(_key2, '="').concat(Utils.escapeHTML(_value), '"')
              );
            }
          }
          ...
          if (item._data && !Utils.isEmptyObject(item._data)) {
            for (
              var _i9 = 0, _Object$entries8 = Object.entries(item._data);
              _i9 < _Object$entries8.length;
              _i9++
            ) {
              var _Object$entries8$_i = _slicedToArray(
                  _Object$entries8[_i9],
                  2
                ),
              ...
              data_ += " data-"
                .concat(k, "='")
                .concat(_typeof(v) === "object" ? JSON.stringify(v) : v, "'");
            }
          }
          ...
          html.push(
            ...
            Utils.sprintf(
              " %s",
              htmlAttributes.length ? htmlAttributes.join(" ") : undefined
            ),
            Utils.sprintf(
              ' id="%s"',
              Array.isArray(item) ? undefined : item._id
            ),
            Utils.sprintf(
              ' class="%s"',
              style.classes || (Array.isArray(item) ? undefined : item._class)
            ),
            Utils.sprintf(
              ' style="%s"',
              Array.isArray(item) ? undefined : item._style
            ),
            ' data-index="'.concat(i, '"'),
            Utils.sprintf(
              ' data-uniqueid="%s"',
              Utils.getItemField(item, this.options.uniqueId, false)
            ),
            Utils.sprintf(
              ' data-has-detail-view="%s"',
              this.options.detailView &&
                Utils.calculateObjectValue(null, this.options.detailFilter, [
                  i,
                  item,
                ])
                ? "true"
          ...
          this.header.fields.forEach(function (field, j) {
            ...
            if (
              (_this7.fromHtml || _this7.autoMergeCells) &&
            ...
            if (csses.concat([_this7.header.styles[j]]).length) {
              styleToAdd_ += "".concat(
                csses.concat([_this7.header.styles[j]]).join("; ")
              );
            }
            ...
            if (item["_".concat(field, "_class")]) {
              class_ = Utils.sprintf(
                ' class="%s"',
                item["_".concat(field, "_class")]
              );
            }

            if (item["_".concat(field, "_rowspan")]) {
              rowspan_ = Utils.sprintf(
                ' rowspan="%s"',
                item["_".concat(field, "_rowspan")]
              );
            }

            if (item["_".concat(field, "_colspan")]) {
              colspan_ = Utils.sprintf(
                ' colspan="%s"',
                item["_".concat(field, "_colspan")]
              );
            }

            if (item["_".concat(field, "_title")]) {
              title_ = Utils.sprintf(
                ' title="%s"',
                item["_".concat(field, "_title")]
              );
            }

            cellStyle = Utils.calculateObjectValue(
              _this7.header,
              _this7.header.cellStyles[j],
              [value_, item, i, field],
              cellStyle
            );
            ...
            if (cellStyle.css) {
              ...
              for (
                var _i10 = 0, _Object$entries9 = Object.entries(cellStyle.css);
                _i10 < _Object$entries9.length;
                _i10++
              ) {
                var _Object$entries9$_i = _slicedToArray(
                    _Object$entries9[_i10],
                    2
                  ),
              ...
              style_ = ' style="'.concat(
                csses_.concat(_this7.header.styles[j]).join("; "),
                '"'
              );
            }
            ...
            if (
              column.searchable &&
              _this7.searchText &&
              _this7.options.searchHighlight
            ) {
              var defValue = "";
              var regExp = new RegExp(
                "(".concat(
                  _this7.searchText.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"),
                  ")"
                ),
                "gim"
              );
              ...
              if (isHTML) {
                ...
                var textContent = new DOMParser().parseFromString(
                  value.toString(),
                  "text/html"
                ).documentElement.textContent;
                var textReplaced = textContent.replace(regExp, marker);
                defValue = value.replace(
                  new RegExp("(>\\s*)(".concat(textContent, ")(\\s*)"), "gm"),
                  "$1".concat(textReplaced, "$3")
                );
              } else {
                // but usually not
              ...
              value = Utils.calculateObjectValue(
                column,
                column.searchHighlightFormatter,
            ...
            if (
              ...
              !Utils.isEmptyObject(item["_".concat(field, "_data")])
            ) {
              for (
                var _i11 = 0,
                  _Object$entries10 = Object.entries(
                    item["_".concat(field, "_data")]
                  );
                _i11 < _Object$entries10.length;
                _i11++
              ) {
                var _Object$entries10$_i = _slicedToArray(
                    _Object$entries10[_i11],
                    2
                  ),
            ...
            if (column.checkbox || column.radio) {
              ...
              var c = column["class"] || "";
              var isChecked =
                Utils.isObject(value) && value.hasOwnProperty("checked")
                  ? value.checked
                  : (value === true || value_) && value !== false;
              var isDisabled =
                !column.checkboxEnabled || (value && value.disabled);
              text = [
                _this7.options.cardView
                  ? '<div class="card-view '.concat(c, '">')
                ...
                _this7.header.formatters[j] && typeof value === "string"
                  ? value
                  : "",
                _this7.options.cardView ? "</div>" : "</td>",
              ].join("");
              item[_this7.header.stateField] =
                value === true || !!value_ || (value && value.checked);
            } else if (_this7.options.cardView) {
              var cardTitle = _this7.options.showHeader
                ? '<span class="card-view-title '
                    .concat(cellStyle.classes, '"')
                    .concat(style_, ">")
                    .concat(
              ...
              text = '<div class="card-view">'
                .concat(cardTitle, '<span class="card-view-value ')
                .concat(cellStyle.classes, '"')
                .concat(style_, ">")
                .concat(value, "</span></div>");
      ...
      },
      {
        ...
        value: function initBody(fixedScroll) {
          ...
          if (!this.$body.length) {
            this.$body = $__default["default"]("<tbody></tbody>").appendTo(
              this.$el
            );
          ...
          var rows = [];
          var trFragments = $__default["default"](
            document.createDocumentFragment()
          );
          var hasTr = false;
          this.autoMergeCells = Utils.checkAutoMergeCells(
            data.slice(this.pageFrom - 1, this.pageTo)
          );
              ...
              '<tr class="no-records-found">'.concat(
                Utils.sprintf(
                  ...
                  this.getVisibleFields().length +
                    Utils.getDetailViewIndexOffset(this.options),
        ...
        value: function initBodyEvent() {
          ...
          this.$body
            ...
            .on("click dblclick", function (e) {
              ...
              var $tr = $td.parent();
              var $cardViewArr = $__default["default"](e.target)
                .parents(".card-views")
                .children();
              ...
              var index = _this9.options.cardView
                ? $cardViewArr.index($cardViewTarget)
                : $td[0].cellIndex;

              var fields = _this9.getVisibleFields();

              var field =
                fields[index - Utils.getDetailViewIndexOffset(_this9.options)];
              var column = _this9.columns[_this9.fieldsColumnsIndex[field]];
              var value = Utils.getItemField(
                item,
                field,
                _this9.options.escape
              );
              ...
              if (
                e.type === "click" &&
                _this9.options.clickToSelect &&
                column.clickToSelect &&
                !Utils.calculateObjectValue(
                  _this9.options,
                  _this9.options.ignoreClickToSelectOn,
                  [e.target]
                )
              ) {
                var $selectItem = $tr.find(
                  Utils.sprintf('[name="%s"]', _this9.options.selectItemName)
                );
              ...
              if (e.type === "click" && _this9.options.detailViewByClick) {
                _this9.toggleDetailView(
                  rowIndex,
                  _this9.header.detailFormatters[
                    _this9.fieldsColumnsIndex[field]
                  ]
                );
              }
            })
          ...
          this.$body
            ...
            .on("click", function (e) {
              ...
              _this9.toggleDetailView(
                $__default["default"](e.currentTarget)
                  .parent()
                  .parent()
                  .data("index")
              );
            ...
            var _loop2 = function _loop2(key) {
              ...
              _this9.$body
                ...
                .each(function (i, tr) {
                  ...
                  var $td = $tr
                    .find(
                      _this9.options.cardView ? ".card-views>.card-view" : ">td"
                    )
                    .eq(fieldIndex);
      ...
      },
      {
        ...
        value: function initServer(silent, query, url) {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                ...
                if (
                  !column.checkbox &&
                  column.searchable &&
                  ((this.options.visibleSearch && column.visible) ||
          ...
          data = Utils.calculateObjectValue(
            this.options,
          ...
          var request = $__default["default"].extend(
            {},
            Utils.calculateObjectValue(null, this.options.ajaxOptions),
            {
              ...
              success: function success(_res, textStatus, jqXHR) {
                var res = Utils.calculateObjectValue(
                  _this10.options,
                  _this10.options.responseHandler,
                  [_res, jqXHR],
                  _res
                );
                ...
                if (
                  _this10.options.sidePagination === "server" &&
                  res[_this10.options.totalField] > 0 &&
                  !res[_this10.options.dataField].length
                ) {
      ...
      },
      {
        ...
        value: function getCaret() {
          ...
          this.$header.find("th").each(function (i, th) {
            $__default["default"](th)
              .find(".sortable")
              .removeClass("desc asc")
              .addClass(
                $__default["default"](th).data("field") ===
                  _this11.options.sortName
                  ? _this11.options.sortOrder
                  : "both"
              );
          });
        },
      ...
      },
      {
        ...
        value: function updateRows() {
          ...
          this.$selectItem.each(function (i, el) {
            _this12.data[$__default["default"](el).data("index")][
              _this12.header.stateField
            ] = $__default["default"](el).prop("checked");
          });
        },
      },
      ...
      },
      {
        ...
        value: function trigger(_name) {
          ...
          this.$el.trigger(
            $__default["default"].Event(name, {
              sender: this,
            }),
            args
          );

          (_this$options2 = this.options).onAll.apply(
            _this$options2,
            [name].concat([].concat(args, [this]))
          );

          this.$el.trigger(
            $__default["default"].Event("all.bs.table", {
              sender: this,
            }),
            [name, args]
          );
      ...
      },
      {
        ...
        value: function fitHeader() {
          ...
          if (focused.length > 0) {
            ...
            if ($th.length > 0) {
              ...
              if (dataField !== undefined) {
                var $headerTh = this.$header.find(
                  "[data-field='".concat(dataField, "']")
                );
          ...
          this.$header.find("th[data-field]").each(function (i, el) {
            _this14.$header_
              .find(
                Utils.sprintf(
                  'th[data-field="%s"]',
                  $__default["default"](el).data("field")
                )
              )
              .data($__default["default"](el).data());
          });
          var visibleFields = this.getVisibleFields();
          ...
          while (
            $tr.length &&
            $tr.find('>td[colspan]:not([colspan="1"])').length
          ) {
            $tr = $tr.next();
          }
          ...
          $tr.find("> *").each(function (i, el) {
            ...
            if (Utils.hasDetailViewIcon(_this14.options)) {
              if (
                (i === 0 && _this14.options.detailViewAlign !== "right") ||
                (i === trLength - 1 &&
                  _this14.options.detailViewAlign === "right")
              ) {
                var $thDetail = $ths.filter(".detail");

                var _zoomWidth =
                  $thDetail.innerWidth() - $thDetail.find(".fht-cell").width();
            ...
            var $th = _this14.$header_.find(
              Utils.sprintf('th[data-field="%s"]', visibleFields[index])
            );
            ...
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
              ...
              if (
                ...
                (this.footerData &&
                  ...
                  !(column.field in this.footerData[0]))
              ) {
                continue;
              }
              ...
              if (style && style.css) {
                for (
                  var _i12 = 0, _Object$entries11 = Object.entries(style.css);
                  _i12 < _Object$entries11.length;
                  _i12++
                ) {
                  var _Object$entries11$_i = _slicedToArray(
                      _Object$entries11[_i12],
                      2
                    ),
              ...
              if (style && style.classes) {
                class_ = Utils.sprintf(
                  ' class="%s"',
                  column["class"]
                    ? [column["class"], style.classes].join(" ")
                    : style.classes
                );
              }
              ...
              html.push(
                ...
                Utils.sprintf(
                  ' style="%s"',
                  falign + valign + csses.concat().join("; ")
                )
              );
              var colspan = 0;
              ...
              if (this.footerData && this.footerData.length > 0) {
                colspan =
                  this.footerData[0]["_".concat(column.field, "_colspan")] || 0;
              }
        ...
        value: function fitFooter() {
          ...
          $tr.find("> *").each(function (i, el) {
            ...
            if (Utils.hasDetailViewIcon(_this15.options)) {
              if (
                (i === 0 && _this15.options.detailViewAlign === "left") ||
                (i === trLength - 1 &&
                  _this15.options.detailViewAlign === "right")
              ) {
                var $thDetail = $ths.filter(".detail");
                ...
                $thDetail
                  .find(".fht-cell")
                  .width($this.innerWidth() - _zoomWidth2);
                return;
              }
            }
        ...
        value: function getData(params) {
          ...
          if (params && params.formatted) {
            data.forEach(function (row) {
              for (
                var _i13 = 0, _Object$entries12 = Object.entries(row);
                _i13 < _Object$entries12.length;
                _i13++
              ) {
                var _Object$entries12$_i = _slicedToArray(
                    _Object$entries12[_i13],
                    2
                  ),
                ...
                row[key] = Utils.calculateObjectValue(
                  column,
                  _this17.header.formatters[column.fieldIndex],
                  [value, row, row.index, column.field],
                  value
                );
              }
            });
        ...
        value: function load(_data) {
          ...
          if (
            ...
            this.options.totalNotFiltered =
              data[this.options.totalNotFilteredField];
            this.footerData = data[this.options.footerField]
              ? [data[this.options.footerField]]
              : undefined;
          }
        ...
        value: function updateRow(params) {
          ...
          try {
            for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
              ...
              if (
                !_params.hasOwnProperty("index") ||
                !_params.hasOwnProperty("row")
              ) {
                continue;
              }
              ...
              if (_params.hasOwnProperty("replace") && _params.replace) {
                ...
                $__default["default"].extend(
                  this.options.data[_params.index],
                  _params.row
                );
              }
            }
        ...
        value: function getRowByUniqueId(_id) {
          ...
          for (i = len - 1; i >= 0; i--) {
            ...
            if (typeof rowUniqueId === "string") {
              ...
              if (
                Number(rowUniqueId) === rowUniqueId &&
                rowUniqueId % 1 === 0
              ) {
                id = parseInt(id);
              } else if (
                rowUniqueId === Number(rowUniqueId) &&
                rowUniqueId !== 0
              ) {
                id = parseFloat(id);
              }
        ...
        value: function updateByUniqueId(params) {
          ...
          try {
            for (_iterator7.s(); !(_step7 = _iterator7.n()).done; ) {
              ...
              if (
                !_params2.hasOwnProperty("id") ||
                !_params2.hasOwnProperty("row")
              ) {
                continue;
              }

              var rowId = this.options.data.indexOf(
                this.getRowByUniqueId(_params2.id)
              );
      ...
      },
      {
        ...
        value: function updateCellByUniqueId(params) {
          ...
          allParams.forEach(function (_ref6) {
            ...
            var rowId = _this19.options.data.indexOf(
              _this19.getRowByUniqueId(id)
            );
      ...
      },
      {
        ...
        value: function showColumn(field) {
          ...
          fields.forEach(function (field) {
            _this20._toggleColumn(
              _this20.fieldsColumnsIndex[field],
              true,
              true
            );
          });
      ...
      },
      {
        ...
        value: function hideColumn(field) {
          ...
          var fields = Array.isArray(field) ? field : [field];
          fields.forEach(function (field) {
            _this21._toggleColumn(
              _this21.fieldsColumnsIndex[field],
              false,
              true
            );
          });
      ...
      },
      {
        ...
        value: function _toggleColumn(index, checked, needUpdate) {
          ...
          if (this.options.showColumns) {
            ...
            if (needUpdate) {
              $items
                .filter(Utils.sprintf('[value="%s"]', index))
            ...
            if (visible) {
              ...
              $items
                ...
                .forEach(function (item) {
                  if (
                    $items.filter(":checked").length >
                    _this23.options.minimumCountColumns
                  ) {
        ...
        value: function _toggleCheck(checked, index) {
          ...
          if (this.options.multipleSelectRow) {
            if (
              ...
              var _ref8 =
                  this.multipleSelectRowLastSelectedIndex < index
                    ? [this.multipleSelectRowLastSelectedIndex, index]
        ...
        value: function resetView(params) {
          ...
          if (this.$container.hasClass("fullscreen")) {
            ...
            if (this.$tableBorder && $bodyTable.is(":visible")) {
              ...
              if (
                this.$tableBody[0].scrollWidth - this.$tableBody.innerWidth()
              ) {
              ...
              this.$tableBorder.css(
                "width",
                "".concat($bodyTable.outerWidth(), "px")
              );
              this.$tableBorder.css(
                "height",
                "".concat(tableBorderHeight, "px")
              );
            }
          }
      ...
      },
      {
        ...
        value: function filterBy(columns, options) {
          this.filterOptions = Utils.isEmptyObject(options)
            ? this.options.filterOptions
            : $__default["default"].extend(this.options.filterOptions, options);
      ...
      },
      {
        ...
        value: function scrollTo(params) {
          ...
          if (options.unit === "rows") {
            scrollTo = 0;
            this.$body
              .find("> tr:lt(".concat(options.value, ")"))
              .each(function (i, el) {
      ...
      },
      {
        ...
        value: function expandRow(index, _columnDetailFormatter) {
          var row = this.data[index];
          var $tr = this.$body.find(
            Utils.sprintf('> tr[data-index="%s"][data-has-detail-view]', index)
          );
          ...
          var detailFormatter =
            _columnDetailFormatter || this.options.detailFormatter;
          var content = Utils.calculateObjectValue(
            this.options,
            detailFormatter,
            [index, row, $element],
            ""
      ...
      },
      {
        ...
        value: function updateColumnTitle(params) {
          ...
          this.columns[this.fieldsColumnsIndex[params.field]].title = this
            .options.escape
            ? Utils.escapeHTML(params.title)
            : params.title;
          ...
          if (this.columns[this.fieldsColumnsIndex[params.field]].visible) {
            this.$header.find("th[data-field]").each(function (i, el) {
              if ($__default["default"](el).data("field") === params.field) {
                $__default["default"](
                  $__default["default"](el).find(".th-inner")[0]
                ).text(params.title);
                return false;
              }
            });
  ...
  $__default["default"].fn.bootstrapTable.columnDefaults =
    BootstrapTable.COLUMN_DEFAULTS;
