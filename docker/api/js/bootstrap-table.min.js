...
!(function (t, e) {
  ...
  var p = function (t) {
    ...
    A = function (t, e) {
      if (!I(t)) return t;
      var i, n;
      if (e && "function" == typeof (i = t.toString) && !I((n = i.call(t))))
        return n;
  ...
  var W,
    ...
    Y = z.inspectSource,
    X = g.WeakMap,
    J = "function" == typeof X && /native code/.test(Y(X)),
    Q = f(function (t) {
  ...
  var ut = {
    ...
    dt = f(function (t) {
      ...
      (t.exports = function (t, e, o, a) {
        var s,
          ...
          c = !!a && !!a.noTargetGet;
        "function" == typeof o &&
          ("string" != typeof e || E(o, "name") || H(o, "name", e),
          (s = i(o)).source ||
            (s.source = n.join("string" == typeof e ? e : ""))),
          t !== g
            ? (r ? !c && t[e] && (l = !0) : delete t[e],
              l ? (t[e] = o) : H(t, e, o))
            : l
            ? (t[e] = o)
            : M(e, o);
    ...
    Mt = function (t, e) {
      var i,
        ...
        l = t.global,
        c = t.stat;
      if ((i = l ? g : c ? g[r] || M(r, {}) : (g[r] || {}).prototype))
        for (n in e) {
          if (
            ((a = e[n]),
            (o = t.noTargetGet ? (s = Ht(i, n)) && s.value : i[n]),
            !Lt(l ? n : r + (c ? "." : "#") + n, t.forced) && void 0 !== o)
          ) {
    ...
    Gt = function (t) {
      return function (e) {
        var i = String(T(e));
        return (
          1 & t && (i = i.replace(qt, "")), 2 & t && (i = i.replace(Wt, "")), i
        );
      };
    },
    Kt = { start: Gt(1), end: Gt(2), trim: Gt(3) },
    Yt = Kt.trim;
  Mt(
    {
      target: "String",
  ...
  var Xt = function (t, e) {
    ...
    Zt = Xt("join", ",");
  Mt(
    { target: "Array", proto: !0, forced: Qt || !Zt },
    {
      join: function (t) {
  ...
  var ie = {
    ...
    oe = Q("native-string-replace", String.prototype.replace),
    ae = ne,
    se = (function () {
      var t = /a/,
        e = /b*/g;
    ...
    re = ie.UNSUPPORTED_Y || ie.BROKEN_CARET,
    le = void 0 !== /()??/.exec("")[1];
  (se || le || re) &&
    (ae = function (t) {
      var e,
      ...
      return (
        ...
        s
          ? n
            ...
            : (a.lastIndex = 0)
          : se && n && (a.lastIndex = a.global ? n.index + n[0].length : e),
        le &&
          n &&
          n.length > 1 &&
          oe.call(n[0], i, function () {
  ...
  var he,
    ue,
    de = "process" == k(g.process),
    fe = gt("navigator", "userAgent") || "",
    pe = g.process,
    ge = pe && pe.versions,
    ve = ge && ge.v8;
  ve
    ? (ue = (he = ve.split("."))[0] + he[1])
    : fe &&
      (!(he = fe.match(/Edge\/(\d+)/)) || he[1] >= 74) &&
      (he = fe.match(/Chrome\/(\d+)/)) &&
      (ue = he[1]);
  var be = ue && +ue,
    me =
    ...
    ye = me && !Symbol.sham && "symbol" == typeof Symbol.iterator,
    we = Q("wks"),
    Se = g.Symbol,
    xe = ye ? Se : (Se && Se.withoutSetter) || et,
    ke = function (t) {
      return (
        (E(we, t) && (me || "string" == typeof we[t])) ||
          (me && E(Se, t) ? (we[t] = Se[t]) : (we[t] = xe("Symbol." + t))),
        we[t]
      );
    },
    Oe = ke("species"),
          ...
          l = i(
            ...
            function (t, e, i, n, o) {
              return e.exec === RegExp.prototype.exec
                ? a && !o
                  ? { done: !0, value: r.call(e, i, n) }
                  : { done: !0, value: t.call(i, e, n) }
                : { done: !1 };
            },
            {
              REPLACE_KEEPS_$0: Te,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ie,
            }
          ),
          c = l[0],
          h = l[1];
        dt(String.prototype, t, c),
          dt(
            RegExp.prototype,
            o,
            2 == e
    ...
    Fe = { codeAt: Ne(!1), charAt: Ne(!0) }.charAt,
    De = function (t, e, i) {
        ...
        [
          ...
          function (t, o) {
            ...
            for (var f = 0, p = 0, g = []; p < r.length; ) {
              u.lastIndex = Be ? 0 : p;
              var v,
                b = Ve(u, Be ? r.slice(p) : r);
              if (
                null === b ||
                (v = He(wt(u.lastIndex + (Be ? p : 0)), r.length)) === f
              )
                p = De(r, p, c);
              else {
  ...
  var Ue =
    ...
    qe = function (t) {
      return function (e) {
        for (var i, n = P(e), o = Ue(n), a = o.length, s = 0, r = []; a > s; )
          (i = o[s++]), (b && !ze.call(n, i)) || r.push(t ? [i, n[i]] : n[i]);
        return r;
      };
    },
  ...
  var Ge,
    Ke = b
      ...
      : function (t, e) {
          V(t);
          for (var i, n = Ue(e), o = n.length, a = 0; o > a; )
            L.f(t, (i = n[a++]), e[i]);
          return t;
        },
    Ye = gt("document", "documentElement"),
    Xe = nt("IE_PROTO"),
    Je = function () {},
    Qe = function (t) {
    ...
    ci = function (t, e) {
      ...
      return (
        ai(t) &&
          ...
          (i !== Array && !ai(i.prototype))
            ? I(i) && null === (i = i[li]) && (i = void 0)
            : (i = void 0)),
  ...
  Mt(
    { target: "Array", proto: !0, forced: !gi || !vi },
    {
      concat: function (t) {
        var e,
          i,
      ...
      return function (l, c, h, u) {
        for (
          var d,
            ...
            m = 0,
            y = u || ci,
            w = e ? y(l, b) : i || s ? y(l, 0) : void 0;
          b > m;
          m++
        )
          if ((r || m in g) && ((f = v((d = g[m]), m, p)), t))
            if (e) w[m] = f;
            else if (f)
              switch (t) {
                case 3:
  ...
  Mt(
    { target: "String", proto: !0, forced: !Ti("includes") },
    {
      includes: function (t) {
  ...
  var Fi = Ct.indexOf,
    Di = [].indexOf,
    Vi = !!Di && 1 / [1].indexOf(1, -0) < 0,
    Bi = Xt("indexOf");
  Mt(
    { target: "Array", proto: !0, forced: Vi || !Bi },
    {
      indexOf: function (t) {
        return Vi
          ? Di.apply(this, arguments) || 0
          : Fi(this, t, arguments.length > 1 ? arguments[1] : void 0);
      },
    }
  );
  var Li = [],
    ...
    zi = Xt("sort");
  Mt(
    { target: "Array", proto: !0, forced: Mi || !Ui || !zi },
    {
      sort: function (t) {
  ...
  var qi = Math.floor,
    ...
    Yi = function (t, e, i, n, o, a) {
      var s = i + t.length,
        ...
        l = Ki;
      return (
        void 0 !== o && ((o = si(o)), (l = Gi)),
        Wi.call(a, l, function (a, l) {
          var c;
          switch (l.charAt(0)) {
            case "$":
              return "$";
    ...
    return [
      ...
      function (t, n) {
        ...
        for (var g, v = "", b = 0, m = 0; m < f.length; m++) {
          ...
          for (
            var y = String(p[0]),
              w = Xi(Ji(mt(p.index), c.length), 0),
              S = [],
              x = 1;
            x < p.length;
            x++
          )
            S.push(void 0 === (g = p[x]) ? g : String(g));
          var k = p.groups;
          if (h) {
  ...
  var Qi = Object.assign,
    ...
    tn =
      ...
      v(function () {
        ...
        ? function (t, e) {
            for (
              var i = si(t), n = arguments.length, o = 1, a = Et.f, s = w.f;
              n > o;
              ...
              for (
                var r,
                  l = C(arguments[o++]),
                  c = a ? Ue(l).concat(a(l)) : Ue(l),
                  h = c.length,
                  u = 0;
                h > u;

              )
                (r = c[u++]), (b && !s.call(l, r)) || (i[r] = l[r]);
            return i;
          }
        : Qi;
  Mt(
    { target: "Object", stat: !0, forced: Object.assign !== tn },
    { assign: tn }
  );
  var en = wi.filter,
    nn = ui("filter");
  Mt(
    { target: "Array", proto: !0, forced: !nn },
    {
      filter: function (t) {
  ...
  $e("search", 1, function (t, e, i) {
    return [
      ...
      function (t) {
        ...
        var r = Ve(o, a);
        return (
          on(o.lastIndex, s) || (o.lastIndex = s), null === r ? -1 : r.index
        );
      },
    ];
  });
  ...
  var cn = wi.map,
    hn = ui("map");
  Mt(
    { target: "Array", proto: !0, forced: !hn },
    {
      map: function (t) {
  ...
  if (
    ...
    Lt(
      ...
      !Cn ||
        ...
        v(function () {
          return (
            (On[wn] = !1), Sn(kn) != kn || Sn(On) == On || "/a/i" != Sn(kn, "i")
          );
        })
    )
  ) {
    for (
      var Pn = function (t, e) {
          var i,
            n = this instanceof Pn,
            o = Re(t),
            a = void 0 === e;
          if (!n && o && t.constructor === Pn && a) return t;
          Cn
            ? o && !a && (t = t.source)
            : t instanceof Pn && (a && (e = te.call(t)), (t = t.source)),
            Tn && (i = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""));
    ...
    dt(
      ...
      function () {
        ...
        return (
          ...
          "/" +
          String(
            void 0 === i && t instanceof RegExp && !("flags" in Rn)
              ? te.call(t)
              : i
          )
        );
    ...
    Ln = Dn
      ...
      : function (t) {
          ...
          return void 0 === t
            ...
            : Bn
            ? k(e)
            : "Object" == (n = k(e)) && "function" == typeof e.callee
            ? "Arguments"
            : n;
        },
    Hn = Dn
    ...
    { target: "Array", proto: !0, forced: !Mn },
    {
      slice: function (t, e) {
        ...
        if (
          ...
          (i !== Array && !ai(i.prototype))
            ? I(i) && null === (i = i[Un]) && (i = void 0)
            : (i = void 0),
          i === Array || void 0 === i)
        )
          return zn.call(a, r, l);
        for (
          n = new (void 0 === i ? Array : i)(qn(l - r, 0)), o = 0;
          r < l;
          r++, o++
        )
          r in a && ri(n, o, a[r]);
  ...
  [].keys &&
    ("next" in (Kn = [].keys())
      ? (Gn = Qn(Qn(Kn))) !== Object.prototype && (Wn = Gn)
      : (to = !0)),
    (null == Wn ||
      v(function () {
        var t = {};
  ...
  var eo = { IteratorPrototype: Wn, BUGGY_SAFARI_ITERATORS: to },
    io = L.f,
    no = ke("toStringTag"),
    oo = function (t, e, i) {
      t &&
        !E((t = i ? t : t.prototype), no) &&
        io(t, no, { configurable: !0, value: e });
    },
    ao = eo.IteratorPrototype,
    so = eo.IteratorPrototype,
    ro = eo.BUGGY_SAFARI_ITERATORS,
    lo = ke("iterator"),
    co = "keys",
    ho = "values",
    uo = "entries",
      ...
      if (
        (v &&
          ...
          so !== Object.prototype &&
            r.next &&
            (Qn(r) !== so &&
              (pn ? pn(r, so) : "function" != typeof r[lo] && H(r, lo, fo)),
            oo(r, u, !0))),
        o == ho &&
          p &&
          p.name !== ho &&
        ...
        if (((l = { values: h(ho), keys: a ? g : h(co), entries: h(uo) }), s))
          for (c in l) (ro || d || !(c in f)) && dt(f, c, l[c]);
        else Mt({ target: e, proto: !0, forced: ro || d }, l);
      return l;
    })(
      Array,
      "Array",
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === u
            ...
            : 1 === u
            ? ((i = 0), (n = c - h))
            : ((i = u - 2), (n = Po(To(mt(e), 0), c - h))),
          c + i - n > Io)
        )
          throw TypeError(Ao);
        for (o = ci(l, n), a = 0; a < n; a++)
          (s = h + a) in l && ri(o, a, l[s]);
        if (((o.length = n), i < n)) {
          for (a = h; a < c - n; a++)
  ...
  var $o = $t.f,
    ...
    Vo = function (t) {
      ...
      if ("string" == typeof c && c.length > 2)
        if (43 === (e = (c = jo(c)).charCodeAt(0)) || 45 === e) {
  ...
  if (Lt(_o, !No(" 0o1") || !No("0b1") || No("+0x1"))) {
    for (
      ...
      E(No, (Bo = Ho[Mo])) && !E(Lo, Bo) && Ro(Lo, Bo, Eo(No, Bo));
    (Lo.prototype = Fo), (Fo.constructor = Lo), dt(g, _o, Lo);
  }
  var Uo = [].reverse,
    zo = [1, 2];
  Mt(
    { target: "Array", proto: !0, forced: String(zo) === String(zo.reverse()) },
    {
      reverse: function () {
  ...
  Mt(
    { target: "Object", stat: !0, forced: Zo },
    {
      keys: function (t) {
        return Ue(si(t));
      },
      ...
      return [
        ...
        function (t) {
          ...
          for (var r, l = [], c = 0; null !== (r = Ve(o, a)); ) {
            var h = String(r[0]);
            (l[c] = h),
              "" === h && (o.lastIndex = De(a, wt(o.lastIndex), s)),
              c++;
          }
          return 0 === c ? null : l;
        },
  ...
  var ta,
    ...
    oa = Ti("startsWith"),
    aa = !(
      oa || ((ta = ea(String.prototype, "startsWith")), !ta || ta.writable)
    );
  Mt(
    { target: "String", proto: !0, forced: !aa && !oa },
    {
      startsWith: function (t) {
        var e = String(T(this));
        Oi(t);
        var i = wt(na(arguments.length > 1 ? arguments[1] : void 0, e.length)),
          n = String(t);
  ...
  Mt(
    { target: "String", proto: !0, forced: !ha && !ca },
    {
      endsWith: function (t) {
        var e = String(T(this));
        Oi(t);
  ...
  var ua = {
                ...
                if (r.colspanGroup > 1) {
                  for (
                    var c = 0,
                      ...
                      d = r.colspanIndex;
                    d < r.colspanIndex + r.colspanGroup;
                    d++
                  )
                    h(d);
      ...
      calculateObjectValue: function (t, e, i, o) {
        ...
        return null !== a && "object" === n(a)
          ? a
          : "function" == typeof a
          ? a.apply(t, i || [])
          : !a &&
            "string" == typeof e &&
            this.sprintf.apply(this, [e].concat(l(i)))
          ? this.sprintf.apply(this, [e].concat(l(i)))
          : o;
      },
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.constants.buttonsClass = [
                t.buttonsPrefix,
                e + t.buttonsClass,
                ua.sprintf("".concat(e, "%s"), t.iconSize),
              ]
                .join(" ")
                .trim()),
                (this.buttons = ua.calculateObjectValue(
                  this,
                  t.buttons,
                  [],
                  {}
                )),
                "object" !== n(this.buttons) && (this.buttons = {}),
                "string" == typeof t.icons &&
                  (t.icons = ua.calculateObjectValue(null, t.icons));
            },
          },
          {
            key: "initLocale",
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                ua.setFieldIndex(this.options.columns),
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.header = {
                ...
                ua.updateFieldGroup(this.options.columns),
                this.options.columns.forEach(function (i, o) {
                  var a = [];
                  a.push(
                    "<tr"
                      .concat(
                        ua.sprintf(' class="%s"', t._headerTrClasses[o]),
                        " "
                      )
                      .concat(
                        ua.sprintf(' style="%s"', t._headerTrStyles[o]),
                        ">"
                      )
                  );
                  var s = "";
                  ...
                  s && "right" !== t.options.detailViewAlign && a.push(s),
                    i.forEach(function (i, n) {
                      var s = ua.sprintf(' class="%s"', i.class),
                        l = i.widthUnit,
                      ...
                      if (
                        ...
                        if (f && f.css)
                          for (
                            var v = 0, b = Object.entries(f.css);
                            v < b.length;
                            v++
                          ) {
                            var m = r(b[v], 2),
                        ...
                        if (
                          ...
                          if (
                            ...
                            (t.header.styles[i.fieldIndex] = u + d),
                        ...
                        a.push(
                          "<th".concat(
                            ua.sprintf(' title="%s"', i.titleTooltip)
                          ),
                          i.checkbox || i.radio
                            ? ua.sprintf(
                                ' class="bs-checkbox %s"',
                            ...
                            : g || s,
                          ua.sprintf(' style="%s"', h + d + p.join("; ")),
                          ua.sprintf(' rowspan="%s"', i.rowspan),
                          ua.sprintf(' colspan="%s"', i.colspan),
                          ua.sprintf(' data-field="%s"', i.field),
                        ...
                        var S = t.options.escape
                            ? ua.escapeHTML(i.title)
                            : i.title,
                          x = S;
                        i.checkbox &&
                          ((S = ""),
                          ...
                          i.radio &&
                            ((S = ""), (t.header.stateField = i.field)),
                          !S && i.showSelectTitle && (S += x),
                          a.push(S),
                          a.push("</div>"),
          ...
          },
          {
            ...
            value: function (t, e) {
              "append" === e
                ...
                : ((t = t || ua.deepCopy(this.options.data)),
                  (this.options.data = Array.isArray(t)
                    ? t
                    : t[this.options.dataField])),
                (this.data = l(this.options.data)),
                this.options.sortReset && (this.unsortedData = l(this.data)),
          ...
          },
          {
            ...
            value: function () {
              ...
              -1 !== n
                ? (this.options.sortStable &&
                  ...
                  this.options.customSort
                    ...
                    : this.data.sort(function (o, a) {
                        ...
                        var s = ua.getItemField(o, e, t.options.escape),
                          r = ua.getItemField(a, e, t.options.escape),
                          l = ua.calculateObjectValue(
                            t.header,
                            t.header.sorters[n],
                            [s, r, o, a]
                          );
                ...
                : this.options.sortReset && (this.data = l(this.unsortedData));
            },
          },
          {
            key: "onSort",
          ...
          },
          {
            ...
            value: function () {
              ...
              this.$toolbar.find(".bs-bars").children().length &&
                i.default("body").append(i.default(o.toolbar)),
                this.$toolbar.html(""),
                ("string" != typeof o.toolbar && "object" !== n(o.toolbar)) ||
                  i
                    .default(
                      ua.sprintf(
                  ...
                  '<div class="'.concat(
                    [
                      ...
                      ""
                        ...
                        .concat(o.buttonsAlign),
                    ].join(" "),
                    '">'
                  ),
                ]),
                "string" == typeof o.buttonsOrder &&
                  (o.buttonsOrder = o.buttonsOrder
                    .replace(/\[|\]| |'/g, "")
                    .split(",")),
                (this.buttons = Object.assign(this.buttons, {
                  paginationSwitch: {
                    text: o.pagination
                      ? o.formatPaginationSwitchUp()
                      : o.formatPaginationSwitchDown(),
                    icon: o.pagination
                      ? o.icons.paginationSwitchDown
                      : o.icons.paginationSwitchUp,
                    render: !1,
                      ...
                      return (
                        ...
                        e.columns.forEach(function (i, a) {
                          if (
                            ...
                            (!o.cardView || i.cardVisible)
                          ) {
                            var s = i.visible ? ' checked="checked"' : "",
                              r =
                                n <= o.minimumCountColumns && s
                                  ? ' disabled="disabled"'
                                  : "";
                            i.switchable &&
                              (t.push(
              ...
              for (
                var c = {}, h = 0, d = Object.entries(this.buttons);
                h < d.length;
                h++
              ) {
                var f = r(d[h], 2),
                ...
                if (g.hasOwnProperty("html"))
                  ...
                  if (
                    ...
                    for (
                      var b = 0, m = Object.entries(g.attributes);
                      b < m.length;
                      b++
                    ) {
                      var y = r(m[b], 2),
                ...
                !(
                  ...
                  (void 0 !== k && !0 !== k) ||
                  (o[x] = !0),
                  o.buttonsOrder.includes(p) || o.buttonsOrder.push(p);
              }
              var O,
                C = u(o.buttonsOrder);
              try {
              ...
              a.push("</div>"),
                (this.showToolbar || a.length > 2) &&
                  this.$toolbar.append(a.join(""));
              for (
                var P = 0, I = Object.entries(this.buttons);
                P < I.length;
                P++
              ) {
                var A = r(I[P], 2),
              ...
              if (
                (o.search || this.showSearchClearButton) &&
                "string" != typeof o.searchSelector
              ) {
                a = [];
                var L = ua.sprintf(
                ...
                if (o.showSearchButton || o.showSearchClearButton) {
                  var z =
                    (o.showSearchButton ? L : "") +
                    (o.showSearchClearButton ? H : "");
                  U = o.search
                    ? ua.sprintf(this.constants.html.inputGroup, M, z)
                    : z;
                }
                a.push(
                  ua.sprintf(
            ...
            value: function () {
              ...
              if (void 0 !== e && i.default(e).length && o) {
                ...
                if (
                  ...
                  return;
                var s = ua.getSearchInput(this),
                  r = e instanceof jQuery ? e : i.default(e);
                (r.is(s) || r.hasClass("search-input")) &&
            ...
            value: function () {
              ...
              if (
                ...
                if (this.options.customSearch)
                  return (
                    (this.data = ua.calculateObjectValue(
                      this.options,
                    ...
                    void (
                      ...
                      (this.unsortedData = l(this.data))
                    )
                  );
                var e =
                    this.searchText &&
                    (this.fromHtml
                      ? ua.escapeHTML(this.searchText)
                      : this.searchText),
                  i = e ? e.toLowerCase() : "",
                  n = ua.isEmptyObject(this.filterColumns)
                    ? null
                    : this.filterColumns;
                this.options.searchAccentNeutralise &&
                  (i = ua.normalizeAccent(i)),
                      ...
                      (this.data = n
                        ? this.options.data.filter(function (e) {
                            ...
                            if ("and" === i) {
                              ...
                              var a = !1;
                              for (var s in n)
                                ((Array.isArray(n[s]) && n[s].includes(e[s])) ||
                                  (!Array.isArray(n[s]) && e[s] === n[s])) &&
                                  (a = !0);
                              return a;
                            }
                            return !0;
                ...
                (this.data = i
                  ? this.data.filter(function (n, a) {
                      for (var s = 0; s < t.header.fields.length; s++)
                        if (
                          t.header.searchables[s] &&
                          (!t.options.visibleSearch ||
                            -1 !== o.indexOf(t.header.fields[s]))
                        ) {
                          var r = ua.isNumeric(t.header.fields[s])
                          ...
                          if ("string" == typeof r) {
                            c = n;
                            for (var h = r.split("."), u = 0; u < h.length; u++)
                              null !== c[h[u]] && (c = c[h[u]]);
                          } else c = n[r];
                          if (
                            (t.options.searchAccentNeutralise &&
                              (c = ua.normalizeAccent(c)),
                            l &&
                              l.searchFormatter &&
                              (c = ua.calculateObjectValue(
                                l,
                                t.header.formatters[s],
                                [c, n, a, l.field],
                                c
                              )),
                            ...
                            if (
                              (t.options.strictSearch &&
                                "".concat(c).toLowerCase() === i) ||
                              (t.options.regexSearch && ua.regexCompare(c, e))
                            )
                              return !0;
                            var d =
                                /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(-?\d+)?|(-?\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm.exec(
                  ...
                  d.forEach(function (i, n) {
                    ...
                    (!e.smartDisplay ||
                      ...
                      ((o = h
                        ...
                        : ""),
                      p.push(
                        ua.sprintf(t.constants.html.pageDropdownItem, o, i)
                      ));
                  }),
                    p.push(
                ...
                if (
                  ...
                  c.push(
                    ...
                    ua.sprintf(
                      ...
                      ua.sprintf(" pagination-%s", e.iconSize)
                    ),
                    ua.sprintf(
            ...
            value: function (t, e, i, o) {
              ...
              if (!(ua.findIndex(this.hiddenRows, t) > -1)) {
                if (
                  ...
                  for (
                    var f = 0, p = Object.entries(l.css);
                    f < p.length;
                    f++
                  ) {
                    var g = r(p[f], 2),
                ...
                if (t._data && !ua.isEmptyObject(t._data))
                  for (
                    var k = 0, O = Object.entries(t._data);
                    k < O.length;
                    k++
                  ) {
                    var C = r(O[k], 2),
                    ...
                    h += " data-"
                      .concat(T, "='")
                      .concat("object" === n(P) ? JSON.stringify(P) : P, "'");
                  }
                s.push(
                  "<tr",
                  ua.sprintf(" %s", d.length ? d.join(" ") : void 0),
                  ua.sprintf(' id="%s"', Array.isArray(t) ? void 0 : t._id),
                  ua.sprintf(
                    ' class="%s"',
                    l.classes || (Array.isArray(t) ? void 0 : t._class)
                  ),
                  ua.sprintf(
                    ' style="%s"',
                  ...
                  ua.sprintf(
                    ' data-uniqueid="%s"',
                    ua.getItemField(t, this.options.uniqueId, !1)
                  ),
                  ua.sprintf(
                    ' data-has-detail-view="%s"',
                    this.options.detailView &&
                      ua.calculateObjectValue(null, this.options.detailFilter, [
                        e,
                        t,
                      ])
                      ? "true"
                ...
                var I = "";
                return (
                  ua.hasDetailViewIcon(this.options) &&
                    ((I = "<td>"),
                    ua.calculateObjectValue(null, this.options.detailFilter, [
                      e,
                      t,
                  ...
                  this.header.fields.forEach(function (i, n) {
                    var o = "",
                      l = ua.getItemField(t, i, a.options.escape),
                      h = "",
                      u = "",
                      d = {},
                      f = "",
                      p = a.header.classes[n],
                      g = "",
                      v = "",
                      b = "",
                      m = "",
                      ...
                      S = a.columns[n];
                    if (
                      ((!a.fromHtml && !a.autoMergeCells) ||
                        void 0 !== l ||
                        S.checkbox ||
                        S.radio) &&
                      S.visible &&
                      (!a.options.cardView || S.cardVisible)
                    ) {
                      if (
                        (S.escape && (l = ua.escapeHTML(l)),
                        c.concat([a.header.styles[n]]).length &&
                          (v += "".concat(
                            c.concat([a.header.styles[n]]).join("; ")
                          )),
                        t["_".concat(i, "_style")] &&
                          (v += "".concat(t["_".concat(i, "_style")])),
                        v && (g = ' style="'.concat(v, '"')),
                        t["_".concat(i, "_id")] &&
                          (f = ua.sprintf(' id="%s"', t["_".concat(i, "_id")])),
                        t["_".concat(i, "_class")] &&
                          (p = ua.sprintf(
                            ' class="%s"',
                            t["_".concat(i, "_class")]
                        ...
                        (d = ua.calculateObjectValue(
                          a.header,
                          a.header.cellStyles[n],
                          [l, t, e, i],
                          d
                        )).classes && (p = ' class="'.concat(d.classes, '"')),
                        d.css)
                      ) {
                        for (
                          var x = [], k = 0, O = Object.entries(d.css);
                          k < O.length;
                          k++
                        ) {
                          var C = r(O[k], 2),
                        ...
                        g = ' style="'.concat(
                          x.concat(a.header.styles[n]).join("; "),
                          '"'
                        );
                      }
                      if (
                        ((h = ua.calculateObjectValue(
                          S,
                          a.header.formatters[n],
                          [l, t, e, i],
                          l
                        )),
                        S.checkbox ||
                          S.radio ||
                          (h = null == h ? a.options.undefinedText : h),
                        S.searchable &&
                          a.searchText &&
                          a.options.searchHighlight &&
                          !S.checkbox &&
                          !S.radio)
                      ) {
                        var I = "",
                        ...
                        if (
                          ...
                          (E = E.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")),
                            (I = h.replace(
                              new RegExp("(>\\s*)(".concat(E, ")(\\s*)"), "gm"),
                              "$1".concat(R, "$3")
                            ));
                        } else I = h.toString().replace(A, $);
                        h = ua.calculateObjectValue(
                          S,
                          S.searchHighlightFormatter,
                          [h, a.searchText],
                          I
                        );
                      }
                      if (
                        t["_".concat(i, "_data")] &&
                        !ua.isEmptyObject(t["_".concat(i, "_data")])
                      )
                        for (
                          var j = 0,
                            _ = Object.entries(t["_".concat(i, "_data")]);
                          j < _.length;
                          j++
                        ) {
                          var N = r(_[j], 2),
                      ...
                      if (S.checkbox || S.radio) {
                        (u = S.checkbox ? "checkbox" : u),
                          (u = S.radio ? "radio" : u);
                        var V = S.class || "",
                          B =
                            ua.isObject(h) && h.hasOwnProperty("checked")
                              ? h.checked
                              : (!0 === h || l) && !1 !== h,
                          L = !S.checkboxEnabled || (h && h.disabled);
                        (o = [
                          a.options.cardView
                            ? '<div class="card-view '.concat(V, '">')
                          ...
                          '<label>\n            <input\n            data-index="'
                            .concat(e, '"\n            name="')
                            .concat(
                              a.options.selectItemName,
                              '"\n            type="'
                            )
                            .concat(u, '"\n            ')
                            .concat(
                              ua.sprintf('value="%s"', t[a.options.idField]),
                              "\n            "
                            )
                            .concat(
                              ua.sprintf(
                          ...
                          a.header.formatters[n] && "string" == typeof h
                            ? h
                            : "",
                          a.options.cardView ? "</div>" : "</td>",
                        ].join("")),
                          (t[a.header.stateField] =
                            !0 === h || !!l || (h && h.checked));
                      } else if (a.options.cardView) {
                        var H = a.options.showHeader
                          ? '<span class="card-view-title '
                              .concat(d.classes, '"')
                              .concat(g, ">")
                              .concat(ua.getFieldTitle(a.columns, i), "</span>")
                          : "";
                        (o = '<div class="card-view">'
                          .concat(H, '<span class="card-view-value ')
                          .concat(d.classes, '"')
                          .concat(g, ">")
                          .concat(h, "</span></div>")),
                          a.options.smartDisplay &&
                            "" === h &&
                            (o = '<div class="card-view"></div>');
                      } else
                        o = "<td"
                          .concat(f)
                          .concat(p)
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var a = [],
                s = i.default(document.createDocumentFragment()),
                r = !1,
                l = [];
              this.autoMergeCells = ua.checkAutoMergeCells(
                o.slice(this.pageFrom - 1, this.pageTo)
              );
              for (var c = this.pageFrom - 1; c < this.pageTo; c++) {
                var h = o[c],
                  u = this.initRow(h, c, o, s);
                  ...
                  if (d && h.hasOwnProperty(d)) {
                    var f = h[d],
                      p = this.$body
                        ...
                        .next();
                    p.is("tr.detail-view") &&
                      (l.push(c), (e && f === e) || (u += p[0].outerHTML));
                  }
                    ...
                    '<tr class="no-records-found">'.concat(
                      ua.sprintf(
                        ...
                        this.getVisibleFields().length +
                          ua.getDetailViewIndexOffset(this.options),
              ...
              this.$body
                ...
                .on("click dblclick", function (e) {
                  var n = i.default(e.currentTarget),
                    ...
                    h =
                      t.getVisibleFields()[
                        c - ua.getDetailViewIndexOffset(t.options)
                      ],
                    u = t.columns[t.fieldsColumnsIndex[h]],
                    d = ua.getItemField(l, h, t.options.escape);
                  if (!n.find(".detail-icon").length) {
                    if (
                      ...
                      var f = o.find(
                        ua.sprintf('[name="%s"]', t.options.selectItemName)
                      );
                      f.length && f[0].click();
                    }
                    "click" === e.type &&
                ...
                (this.$selectItem = this.$body.find(
                  ua.sprintf('[name="%s"]', this.options.selectItemName)
                )),
                ...
                this.header.events.forEach(function (e, n) {
                  ...
                  if (o) {
                    "string" == typeof o &&
                      (o = ua.calculateObjectValue(null, o));
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (
                ...
                if (
                  (ua.isEmptyObject(this.filterColumnsPartial) ||
                  ...
                  var d = i.default.extend(
                    {},
                    ua.calculateObjectValue(null, this.options.ajaxOptions),
                    {
          ...
          },
          {
            ...
            value: function () {
              ...
              this.$selectItem.each(function (e, n) {
                t.data[i.default(n).data("index")][t.header.stateField] = i
                  .default(n)
                  .prop("checked");
              });
            },
            ...
            value: function () {
              ...
              if (this.$el.is(":hidden"))
                ...
                u.find("> *").each(function (e, n) {
                  var o = i.default(n);
                  if (
                    ua.hasDetailViewIcon(t.options) &&
                    ...
                    var r = e - ua.getDetailViewIndexOffset(t.options),
                      l = t.$header_.find(
                        ua.sprintf('th[data-field="%s"]', c[r])
                      );
                ...
                try {
                  for (o.s(); !(n = o.n()).done; ) {
                    var a,
                      ...
                      c = [],
                      h = {},
                      d = ua.sprintf(' class="%s"', l.class);
                    if (
                      !(
                        !l.visible ||
                        (this.footerData &&
                          this.footerData.length > 0 &&
                          !(l.field in this.footerData[0]))
                      )
                    ) {
                      ...
                      if (
                        ((a = ua.sprintf(
                          "text-align: %s; ",
                          l.falign ? l.falign : l.align
                        )),
                        (s = ua.sprintf("vertical-align: %s; ", l.valign)),
                        (h = ua.calculateObjectValue(
                          null,
                        ...
                        for (
                          var f = 0, p = Object.entries(h.css);
                          f < p.length;
                          f++
                        ) {
                          var g = r(p[f], 2),
                      ...
                      h &&
                        ...
                        (d = ua.sprintf(
                          ' class="%s"',
                          l.class ? [l.class, h.classes].join(" ") : h.classes
                        )),
                        e.push(
                          "<th",
                          d,
                      ...
                      this.footerData &&
                        this.footerData.length > 0 &&
                        (m =
                          this.footerData[0]["_".concat(l.field, "_colspan")] ||
                          0),
          ...
          },
          {
            key: "refreshOptions",
            value: function (t) {
              ua.compareObjects(this.options, t, !0) ||
            ...
            value: function (t) {
              ...
              if (
                ((!(
                  ...
                  ua.isEmptyObject(this.filterColumns) &&
                  ua.isEmptyObject(this.filterColumnsPartial)) ||
                  (t && t.unfiltered) ||
                  (i = this.data),
                t &&
                ...
                t &&
                  ...
                  i.forEach(function (t) {
                    for (var i = 0, n = Object.entries(t); i < n.length; i++) {
                      ...
                      if (!l) return;
                      t[a] = ua.calculateObjectValue(
                        l,
                        e.header.formatters[l.fieldIndex],
                        [s, t, t.index, l.field],
                        s
                      );
                    }
              ...
              try {
                for (o.s(); !(e = o.n()).done; ) {
                  ...
                  if (a.hasOwnProperty("id") && a.hasOwnProperty("row")) {
                    var s = this.options.data.indexOf(
                      this.getRowByUniqueId(a.id)
                    );
                    -1 !== s &&
                      (a.hasOwnProperty("replace") && a.replace
                        ? (this.options.data[s] = a.row)
                        : i.default.extend(this.options.data[s], a.row),
                      (n = a.id));
                  }
                }
              } catch (t) {
            ...
            value: function (t, e, i) {
              if (
                ...
                var n = this.$toolbar
                  ...
                  .prop("disabled", !1);
                i && n.filter(ua.sprintf('[value="%s"]', t)).prop("checked", e),
                  n.filter(":checked").length <=
              ...
              if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                ...
                this.data.forEach(function (o, a) {
                  ...
                  if (e.values.includes(o[e.field])) {
                    var s = i.$selectItem
                        .filter(":enabled")
                        .filter(ua.sprintf('[data-index="%s"]', a)),
                      r =
                        !!e.hasOwnProperty("onlyCurrentPage") &&
                        e.onlyCurrentPage;
                    if (
                      !(s = t ? s.not(":checked") : s.filter(":checked"))
                        .length &&
                      r
                    )
                      return;
          ...
          },
          {
            key: "filterBy",
            value: function (t, e) {
              (this.filterOptions = ua.isEmptyObject(e)
                ? this.options.filterOptions
                : i.default.extend(this.options.filterOptions, e)),
                (this.filterColumns = ua.isEmptyObject(t) ? {} : t),
                (this.options.pageNumber = 1),
                this.initSearch(),
                this.updatePagination();
            },
          ...
          },
          {
            ...
            value: function (t, e) {
              this.$body
                .find(ua.sprintf('> tr[data-index="%s"]', t))
                .next()
                .is("tr.detail-view")
                ? this.collapseRow(t)
                : this.expandRow(t, e),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.data[t],
                n = this.$body.find(
                  ua.sprintf('> tr[data-index="%s"][data-has-detail-view]', t)
                );
              if (
  ...
  return (
    (fa.VERSION = Qo.VERSION),
    (fa.DEFAULTS = Qo.DEFAULTS),
    (fa.LOCALES = Qo.LOCALES),
    (fa.COLUMN_DEFAULTS = Qo.COLUMN_DEFAULTS),
    (fa.METHODS = Qo.METHODS),
    (fa.EVENTS = Qo.EVENTS),
    (i.default.BootstrapTable = fa),
    (i.default.fn.bootstrapTable = function (t) {
      for (
        var e = arguments.length, o = new Array(e > 1 ? e - 1 : 0), a = 1;
        a < e;
        a++
      )
        o[a - 1] = arguments[a];
      ...
      return (
        this.each(function (e, a) {
          ...
          if ("string" == typeof t) {
            var c;
            if (!Qo.METHODS.includes(t))
              throw new Error("Unknown method: ".concat(t));
            if (!r) return;
            (s = (c = r)[t].apply(c, o)),
              "destroy" === t && i.default(a).removeData("bootstrap.table");
          }
          r ||
            ((r = new i.default.BootstrapTable(a, l)),
            i.default(a).data("bootstrap.table", r),
            r.init());
        }),
        void 0 === s ? this : s
      );
    }),
    (i.default.fn.bootstrapTable.Constructor = fa),
    (i.default.fn.bootstrapTable.theme = Qo.THEME),
    (i.default.fn.bootstrapTable.VERSION = Qo.VERSION),
    (i.default.fn.bootstrapTable.defaults = fa.DEFAULTS),
    (i.default.fn.bootstrapTable.columnDefaults = fa.COLUMN_DEFAULTS),
    (i.default.fn.bootstrapTable.events = fa.EVENTS),
    (i.default.fn.bootstrapTable.locales = fa.LOCALES),
    (i.default.fn.bootstrapTable.methods = fa.METHODS),
    (i.default.fn.bootstrapTable.utils = ua),
    i.default(function () {
